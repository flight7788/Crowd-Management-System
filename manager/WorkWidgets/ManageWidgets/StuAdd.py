...
class StuAdd(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.name_input.setStyleSheet("QLineEdit#nameLineEdit{color:white} QLineEdit:focus#nameLineEdit{background:white; color:black}")
        id_label = LabelComponent(14,"ID")
        self.id_input = LineEditComponent("")
        self.id_input.setObjectName("idLineEdit")
        self.id_input.setStyleSheet("QLineEdit#idLineEdit{color:white} QLineEdit:focus#idLineEdit{background:white; color:black}")
        cardid_label = LabelComponent(14,"Card No.")
        self.cardid_input = LineEditComponent("")
        self.cardid_input.setObjectName("cardidLineEdit")
        self.cardid_input.setStyleSheet("QLineEdit#cardidLineEdit{color:white} QLineEdit:focus#cardidLineEdit{background:white; color:black}")
